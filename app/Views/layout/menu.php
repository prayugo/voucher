<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?=site_url()?>" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Logmart</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?=site_url('customer')?>" class="menu-link">
                    <div data-i18n="">Customer</div>
                  </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="<?=site_url('voucher')?>" class="menu-link">
